...
@pytest.mark.parametrize("card_number", [("123"), (""), ("11112222333344445555")])
...
@pytest.mark.parametrize(
    ...
    [("70007922896063611234", "**1234"), ("57421234896043424321", "**4321"), ("42002122896012349876", "**9876")],
)
def test_account_number(account_number, expected):
    assert get_mask_account(account_number) == expected


@pytest.mark.parametrize("account_number", [("123"), (""), ("1111222233334444555566667777")])
