...
def get_mask_card_number(card_number: str) -> str:
    ...
    if not isinstance(card_number, str):
        masks_logger.error(f"Произошла ошибка TypeError: Неверный тип данных номера карты")
        raise TypeError("Неверный тип данных номера карты")
    if len(card_number) != 16:
        masks_logger.error(f"Произошла ошибка ValueError: Неверный формат номера карты")
...
def get_mask_account(account_number: str) -> str:
    ...
    if not isinstance(account_number, str):
        masks_logger.error(f"Произошла ошибка TypeError: Неверный тип данных номера счёта")
        raise TypeError("Неверный тип данных номера счёта")
    if len(account_number) != 20:
        masks_logger.error(f"Произошла ошибка ValueError: Неверный формат номера счёта")
